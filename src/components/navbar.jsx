            ...
            <nav
                ...
                <div
                    className={cn(
                        ...
                        isScrolled && 'bg-background/50 max-w-4xl  backdrop-blur-lg lg:px-5 rounded-2xl'
                    )}>
                    <div
...
const Logo = ({
    ...
    return (
        <span className={cn('flex items-center space-x-2', className)}>
            {/* 
      <img src="https://neurotechh.xyz/logo.png" className={cn('h-10   w-auto bg-foreground rounded-full', className)}>
      </img> */}
            <p className="text-xl font-bold tracking-tighter">Annocat🐈</p>
        </span>
